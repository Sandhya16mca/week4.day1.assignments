...
public class SecurityNames {
	public static void main(String[] args) {
		...
		List<WebElement> findElements = driver
				.findElements(By.xpath("//table[@class='table table-bordered table-condensed table-striped']//th"));
		new ArrayList<String>();
		int rowCount = findElements.size();
		System.out.println(rowCount);
		for (int i = 1; i <= rowCount; i++) {
			String text = driver.findElement(By.xpath(
					"//table[@class='table table-bordered table-condensed table-stripped']///tr[" + i + "]//th[1]"))
					.getText();
